 ...
 {case 1:  //  Read system parameters
  ...
  case 5:  // energy reading at the beginning of the month
  {
     if (IDR < 23)
   {
    ...
    StringGrid2->Cells[0][1+Count_Month]= IntToStr(work_buffer[33])+ "-" + IntToStr(work_buffer[34])+ "-20" + IntToStr(work_buffer[35])+ " " + IntToStr(work_buffer[31]) + ":" +IntToStr(work_buffer[30])+ ":" + IntToStr(work_buffer[29]);
    Count_Month++;
    Packet_received=true;
    ...
    case 7:  // energy reading at the beginning of the yers
  {
     if (IDR < 5)
   {
    ...
    StringGrid2->Cells[0][1+Count_Year]= IntToStr(work_buffer[33])+ "-" + IntToStr(work_buffer[34])+ "-20" + IntToStr(work_buffer[35])+ " " + IntToStr(work_buffer[31]) + ":" +IntToStr(work_buffer[30])+ ":" + IntToStr(work_buffer[29]);
    Count_Year++;
    Packet_received=true;
